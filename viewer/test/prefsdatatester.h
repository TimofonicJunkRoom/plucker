/*
 * $Id: prefsdatatester.h,v 1.3 2004/01/01 14:43:21 nordstrom Exp $
 *
...
extern void TestPrefsDataReadV1( void ) UNIT_TEST_SECTION;
extern void TestPrefsDataReadV2( void ) UNIT_TEST_SECTION;
