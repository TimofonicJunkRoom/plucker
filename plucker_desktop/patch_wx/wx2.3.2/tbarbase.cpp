...
// Created:     04/01/98
// RCS-ID:      $Id: tbarbase.cpp,v 1.1 2002/07/16 20:46:57 robertoconnor Exp $
...
void wxToolBarBase::OnMouseEnter(int id)
{
    ...
    // ROB: Reset the statusbar text when leave, and don't try to set the 
    // statusbar text if there isn't one. (Fixed also in wx CVS. Version 1.43)
    wxString helpstring;
